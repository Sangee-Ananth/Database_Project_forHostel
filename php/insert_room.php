...
$sql=mysqli_query($con,"call sp_insert_room('$room_number','$block_name','$no_of_people','$status')");
if($sql)
{
...
<div class="row">
<div class="col-md-12">
<h3>Insert Record | Insert hostel room facility details</h3>
<hr />
</div>
</div>
...
<input type="text" name="status" class="form-control" maxlength="10" 
required>
</div>
</div> 
